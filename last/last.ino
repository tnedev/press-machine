...
void setup()
{
  ...
  // Arduino pinmodes set up
	...
	digitalWrite (inPin_IzhMan_ReperKrai, HIGH);
        digitalWrite (inPin_IzhMan_ReperKrai, HIGH);
        digitalWrite (inPin_Razmotalka_NozhStart, HIGH);
	digitalWrite (inPin_Razmotalka_NozhStop, HIGH);

	digitalWrite (inPin_Razmotalka_ReadyNozh, HIGH);
	digitalWrite (inPin_Razmotalka_ReadyDisk, HIGH);
